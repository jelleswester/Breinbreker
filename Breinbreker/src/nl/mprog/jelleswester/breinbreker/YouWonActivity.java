 ...
 * 
 * YouWonActivity:
 * This activity gives the user to enter his or her name when their score
 * is high enough to be in the highscore. It contains a back button to
 * StartScreenActivity and a save button which saves the highscore and leads
 * to the HighScoreActivity.
 */
...
public class YouWonActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textView.setText("Your time: " + time[0] + ":" + time[1] + ":"
				+ time[2]);
				...
				public void onClick(View view) {
					...
					if (userName.length() == 0) {
						...
						HighScoreController hs = new HighScoreController(
								mContext);
						Object[] newHighScores = hs.addLocalHighScore(
								highScoreNames, highScoreTimes, positionInRank,
								userName, newTime);
						...
						Intent intent = new Intent(YouWonActivity.this,
								HighScoreActivity.class);
						intent.putExtra(
								HighScoreActivity.EXTRA_HIGH_SCORE_TYPE,
